...
iplot_rates <- rates |> 
  ...
  geom_step_interactive(aes(color = name, tooltip = tooltip, data_id = name),
                        linewidth = 0.29,
                        show.legend = FALSE) +
  annotate(geom = "text", label = "2% inflation target", x = as.Date("1997-11-01"), y = 2.3,
